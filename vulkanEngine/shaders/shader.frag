...
void main() {
    ...
    vec4 colorTexture = texture(sampler2D(texImage[mbo.textureID[materialID]], texSampler), fragTexCoord);

    outColor =  vec4(colorTexture.xyz * (diffuseLight + specularLight), mbo.diffuse[materialID].a);
